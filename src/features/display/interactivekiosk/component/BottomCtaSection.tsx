// 11 · BOTTOM CTA BANNER — "What Should People Be Able to Do Here?"
// Closing call to action over a deterministic placeholder skyline (same
// technique as `components/marketing/TalkToThunderSection` and the Display hub
// page). Eyebrow + heading + lead + a solid and an outline CTA on the left; a
// small stacked-word slogan on the right.

import { ArrowRight, FileText } from "lucide-react";
import Image from "next/image";
import { Link } from "@/i18n/navigation";
import { SectionEyebrow } from "@/components/marketing/SectionEyebrow";
import type { KioskBottomCtaContent } from "../../types/interactivekioskTypes";
import projectCtaImage from "@/image/interactive-kiosk/interactive-project-cta.png";

type BottomCtaSectionProps = {
  content: KioskBottomCtaContent;
};
