// 10 · HOW WE WORK — "From Space to Operation."
// Light section. Header carries a small top-right note instead of a link. Below
// it a four-step flow: a numbered circle, an icon, the step name and a
// " · "-joined item list, arrow-separated from `sm` up and stacking on mobile.

import { Fragment } from "react";
import { ArrowRight, PencilRuler, Search, Truck, Wrench } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { SectionHeader } from "./SectionHeader";
import type { LedHowWeWorkContent } from "../../types/leddisplayTypes";
