// Content shapes for the Display Rental landing page
// (`/what-do-you-need/rent-technology`). Every string is resolved from the
// `RentTechnologyPage` namespace in
// `src/app/[locale]/what-do-you-need/rent-technology/page.tsx` (a Server
// Component) and handed to `RentTechnologyClient` as plain props — the client
// tree never calls `useTranslations`, matching `src/features/home` and
// `src/features/buy-technology`.
...
export type HeroContent = {
  ...
  quoteLink: string;
  /** Handwriting-style slogan laid over the image (kept English in both locales). */
